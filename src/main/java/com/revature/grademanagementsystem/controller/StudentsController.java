...
@ResponseStatus(code=HttpStatus.OK)
	public Students checkStudentById(@RequestParam("id")int studentId) {
...
@ResponseStatus(code=HttpStatus.OK)
	public int insert(@RequestParam("name")String name,@RequestParam("fathername")String fathername,@RequestParam("address")String address,@RequestParam("dob")String dob,@RequestParam("department")Integer department) {
